...
const SignUpFormCheckout = ({ loginRedirectUrl, signUpRedirectUrl }) => {
  ...
  return (
    <div className="grid pb-16 md:grid-cols-2 md:gap-6">
      ...
      <div>
        <div className="flex justify-between border-b-[1px] pt-20 md:pt-0 mb-8">
...
export default SignUpFormCheckout;
