...
import MenuTitle from '@/components/header/MenuTitle';
...
const Contact = () => {
  ...
  return (
    <>
      <div className="w-full md:w-1/4  md:overflow-y-scroll">
      ...
      <div className="w-full md:w-3/4  md:ml-[385px] md:px-40 pb-8 ">
            ...
            >
              ...
              <div className="grid md:grid-cols-1 md:gap-24">
                <div className="  w-full mb-6 group md:flex">
                  ...
                  <div>
                    <label
                      htmlFor="contphone"
                      className="font-secondary p14 md:pl-4"
                    >
                      <input
                        type="checkbox"
                        name="contphone"
                    ...
                    <label
                      htmlFor="contemail"
                      className="font-secondary p14 pl-4"
                    >
                      <input
                        type="checkbox"
                        name="contemail"
              ...
              <div className="grid md:grid-cols-1 md:gap-24">
                <div className="  w-full mb-6 group">
                  <label
                    htmlFor="agree"
                    className="font-secondary p14 uppercase"
                  >
                    <input
                      type="checkbox"
                      name="agree"
                    ...
                    <span className="text-justify">
                      By ticking this box you give Access Behavior Analysis
                      permission to contact you via email or phone.
                      <span className="text-red">*</span>
                    </span>
                  </label>
                </div>
